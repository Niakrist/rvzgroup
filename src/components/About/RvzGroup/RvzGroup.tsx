      ...
      <div className={styles.wrapper}>
        <div className={styles.content}>
          ...
          <Text className={styles.text} tag="p" size="medium">
            Это не просто компания, а команда единомышленников, которая связала
            свою жизнь с производством и поставками подшипников. То, что
            начиналось как предпринимательская идея, переросло в нашу общую
            страсть. Мы ценим каждого нашего партнера как члена большой семьи и
            чувствуем огромную ответственность за качество нашей продукции. Наша
            цель – сделать бренд РВЗ гарантом надежности и долговечности,
            стандартом, которому доверяют. Именно это стремление ведет нас
            вперед и заставляет постоянно совершенствоваться.
          </Text>
