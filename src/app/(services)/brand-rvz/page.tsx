...
export const metadata: Metadata = {
  title: "Подшипники бренд РВЗ напрямую от производителя",
  description:
    "Подшипники РВЗ (Разумный Выбор Запчастей), произведенные с применением передовых технологий и строгим контролем качества на наших заводах. Узнайте больше о нашем бренде и его преимуществах.",
};
