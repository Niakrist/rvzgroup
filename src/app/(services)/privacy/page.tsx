    ...
    <WrapperSection bgSection="grey">
      ...
      <div className={styles.section}>
        ...
        <div className={styles.clause}>
          <p>
            ...
            по обеспечению безопасности персональных данных, предпринимаемые ООО "РВЗ ГРУПП" (далее
            — Оператор).
          </p>
          <ul>
            <li>
            ...
            <li>
              ...
              посетителях веб-сайта https://rvzgroup.ru/.
            </li>
          </ul>
        </div>
      </div>
        ...
        <div className={styles.clause}>
          <ul>
            ...
            <li>
              ...
              определенному или определяемому Пользователю веб-сайта https://rvzgroup.ru/.
            </li>
            <li>
            ...
            <li>2.10. Пользователь — любой посетитель веб-сайта https://rvzgroup.ru/.</li>
            <li>
        ...
        <div className={styles.clause}>
          <ul>
            ...
            <li>
              ...
              является субъект персональных данных. Обрабатываемые персональные данные уничтожаются
              либо обезличиваются по достижении целей обработки или в случае утраты необходимости в
          ...
          <table className={styles.table}>
            <thead>
              <tr>
                ...
                <th>Категории субъектов ПДн</th>
                <th>Состав обрабатываемых персональных данных</th>
                <th>Срок хранения</th>
              </tr>
            </thead>
            <tbody>
              <tr>
                <td>Обработка заявок, поступивших через формы обратной связи на сайте</td>
                <td>
                  Статья 6 (ч.1 п.5) Федерального закона от 27.07.2006 №152-ФЗ "О персональных
                  данных" (обработка необходима для заключения договора по инициативе субъекта
                  персональных данных)
                </td>
                <td>Пользователи сайта, клиенты</td>
                <td>
                  Фамилия, имя, отчество, номер телефона, адрес электронной почты, текст сообщения
                </td>
                <td>
                  Не более 1 года с момента выполнения заявки, если иное не предусмотрено отдельным
                  согласием Пользователя или договором.
                </td>
              </tr>
              <tr>
                <td>Осуществление рассылки новостей, рекламных и информационных материалов</td>
                <td>Согласие субъекта персональных данных, полученное через веб-сайт</td>
                <td>Подписчики рассылки</td>
                <td>Адрес электронной почты, имя</td>
                <td>До отзыва субъектом согласия на обработку персональных данных.</td>
              </tr>
              <tr>
                <td>Проведение статистических и иных исследований на основе обезличенных данных</td>
                <td>Согласие субъекта персональных данных, полученное через веб-сайт</td>
                <td>Пользователи сайта</td>
                <td>Обезличенные данные, собираемые с помощью сервиса Яндекс.Метрика</td>
                <td>
                  В соответствии с пользовательскими соглашениями сервисов, но не более срока,
                  необходимого для целей обработки.
                </td>
              </tr>
            </tbody>
          </table>
      ...
      <div className={styles.section}>
        ...
        <div className={styles.clause}>
          <ul>
            ...
            <li>
              8.3. Оператор осуществляет обработку персональных данных с использованием сервиса
              веб-аналитики (Яндекс.Метрика).
            </li>
            <li>
              8.4. В случае выявления неточностей в персональных данных, Пользователь может
              актуализировать их самостоятельно, путем направления Оператору уведомление на адрес
              электронной почты Оператора info@rvzgroup.ru с пометкой «Актуализация персональных
              данных».
            </li>
            <li>
              8.5. Срок обработки персональных данных определяется достижением целей, для которых
              были собраны персональные данные, если иной срок не предусмотрен договором или
              действующим законодательством. Конкретные сроки хранения для каждой цели обработки
              указаны в разделе 6 настоящей Политики.
            </li>
            <li>
              8.6. Пользователь может в любой момент отозвать свое согласие на обработку
              персональных данных, направив Оператору уведомление посредством электронной почты на
              электронный адрес Оператора info@rvzgroup.ru с пометкой «Отзыв согласия на обработку
              персональных данных».
            </li>
            <li>
              8.7. Вся информация, которая собирается сторонними сервисами, в том числе платежными
            ...
            <li>
              8.8. Установленные субъектом персональных данных запреты на передачу (кроме
            ...
            <li>
              8.9. Оператор при обработке персональных данных обеспечивает конфиденциальность
              персональных данных.
            </li>
            <li>
              8.10. Оператор осуществляет хранение персональных данных в форме, позволяющей
            ...
            <li>
              8.11. Условием прекращения обработки персональных данных может являться достижение
      ...
      <div className={styles.section}>
        ...
        <div className={styles.clause}>
          <ul>
            <li>
              10.1. Оператор обязан уведомить уполномоченный орган по защите прав субъектов
              персональных данных о своем намерении осуществлять трансграничную передачу
              персональных данных до начала осуществления такой деятельности.
            </li>
            <li>
            ...
            <li>
              10.3. Настоящим Пользователь, давая согласие на обработку своих данных с
              использованием сервиса Яндекс.Метрика, подтверждает, что он уведомлен о возможности
              трансграничной передачи своих обезличенных данных и согласен с ней.
            </li>
          </ul>
        </div>
      </div>
        ...
        <div className={styles.clause}>
          <ul>
            <li>
              ...
              электронной почты info@rvzgroup.ru.
            </li>
            <li>
            ...
            <li>
              ...
              адресу https://rvzgroup.ru/privacy.
            </li>
          </ul>
        </div>
      </div>
